...
# *                                                                 * #
# *          SimpleCV    Versión 1.1   Fecha: 03/07/2018            * #
# *                                                                 * #
# ******************************************************************* #
#######################################################################
...
class  Video_Signal_Delay():
    ...
    def __init__(self, camara_id, retraso_video = 10, framerate = 4.0, procesar=True, ruido = True):
        ...
        self.video_ruido = [Image("Clases_Inopya/VideoBuffer_SimpleCV/ruido%d.png" %x) for x in range(5)]  # cargamos la lista de fotogramas correspondientes al ruido
        ...
        self.nivel_ruido_maximo = 5                                     # intensidad con que se mostrará la interferencia
    ...
    def video_remoto(self):
        ...
        if self.FLAG_ruido_activo == True:# and self.procesar == True:
